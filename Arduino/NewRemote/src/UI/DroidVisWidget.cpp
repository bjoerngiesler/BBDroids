...
DroidVisWidget::DroidVisWidget() {
    droidStatusLabel_ = make_shared<Label>();
    battLabel_ = make_shared<Label>();
    driveStatusLabel_ = make_shared<Label>();
    servoStatusLabel_ = make_shared<Label>();
    driveModeLabel_ = make_shared<Label>();
    
    droidStatus_ = make_shared<Label>();
    battStatus_ = make_shared<Label>();
    driveStatus_ = make_shared<Label>();
    servoStatus_ = make_shared<Label>();
    driveMode_ = make_shared<Label>();

    velScale_ = make_shared<RoundScaleWidget>();
    velLabel_ = make_shared<Label>();
    imuDisplay_ = make_shared<IMUWidget>();
...
void DroidVisWidget::configureLabel(shared_ptr<Label>& widget, Telemetry::SubsysStatus type, bool setTitle) {
    switch(type) {
